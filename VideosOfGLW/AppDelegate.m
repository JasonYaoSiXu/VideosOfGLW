...
//    UINavigationController *nVC = [[UINavigationController alloc] initWithRootViewController:[[MainPageViewController alloc] init]];
    _window.rootViewController = [MainPageViewController new];
